...
const EIGO_SENTENCES = [
  ...
  { en: "Endangered species are also the result of hunting and fishing.", ja: "絶滅危惧種は狩猟や漁業の結果でもあります。", grammar: "be the result of ～ は「〜の結果である」。also は文中で「〜でもある」。" },
  { en: "For example, some seal species are now almost extinct because they are killed for their fur to make coats.", ja: "例えば、いくつかのアザラシの種はコートを作るために毛皮目的で殺されるため、今やほとんど絶滅しかけています。", grammar: "are killed は受け身「殺される」。for their fur は「毛皮のために」。to make coats は目的を表す不定詞。" },
  { en: "Tigers are shot to make medicine and tea from their bones, and crocodiles are caught to make bags and shoes.", ja: "トラは骨から薬やお茶を作るために銃殺され、ワニはバッグや靴を作るために捕獲されます。", grammar: "are shot / are caught は受け身。to make ～ は目的を表す不定詞。" },
  { en: "These protect animals from extinction by breeding more endangered animals, which can later be released into the wild.", ja: "これらはより多くの絶滅危惧動物を繁殖させることで動物を絶滅から守り、後に野生に放つことができます。", grammar: "protect A from B は「AをBから守る」。by ～ing は「〜することによって」。which can later be released は関係代名詞節（受け身）。" }
];
